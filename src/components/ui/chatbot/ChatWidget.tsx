          ...
          >
            ...
            <div className="px-3 py-3 border-t border-black/5 flex gap-2">
              <input
                ...
                className="flex-1 text-[13px] bg-[var(--gray-light)] rounded-xl px-3.5 py-2 outline-none focus:ring-2 focus:ring-[var(--brand-mid)] placeholder:text-[var(--gray-text)] text-[var(--charcoal)] disabled:opacity-50"
                style={{ fontFamily: "var(--font-body)" }}
              />
              <button
                onClick={send}
