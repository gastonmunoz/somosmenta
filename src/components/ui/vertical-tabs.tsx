...
export function VerticalTabs() {
  ...
  return (
    <section id="proceso" className="w-full bg-gray-light py-8 md:py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-5 flex flex-col justify-center order-1 pt-4">
            <div className="space-y-1 mb-12">
              <p className="text-[10px] tracking-[4px] uppercase text-brand-mid mb-1">
                Cómo trabajamos
              </p>
              <h2
                className="text-3xl md:text-4xl lg:text-5xl font-normal text-charcoal tracking-tight text-balance"
              ...
              {STEPS.map((step, index) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "group relative flex items-start gap-4 py-6 md:py-8 text-left transition-all duration-500 border-t border-charcoal/10 first:border-0",
                      isActive
                        ? "text-charcoal"
                        : "text-gray-text hover:text-charcoal"
                    )}
                  >
                    <div className="absolute left-[-16px] md:left-[-24px] top-0 bottom-0 w-[2px] bg-charcoal/10">
                      {isActive && (
                        <motion.div
                    ...
                    <div className="flex flex-col gap-2 flex-1">
                      ...
                      <AnimatePresence mode="wait">
                        {isActive && (
                          ...
                          >
                            <p className="text-gray-text text-sm md:text-base font-normal leading-relaxed max-w-sm pb-2">
                              {step.description}
                            </p>
                          </motion.div>
                        )}
          ...
          <div className="lg:col-span-7 flex flex-col justify-end h-full order-2">
            ...
            >
              <div className="relative aspect-4/5 md:aspect-4/3 lg:aspect-16/11 rounded-3xl md:rounded-[2.5rem] overflow-hidden bg-brand-tint border border-charcoal/10">
                ...
                <div className="absolute bottom-6 right-6 md:bottom-8 md:right-8 flex gap-2 md:gap-3 z-20">
                  <button
                    ...
                    className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/80 backdrop-blur-md border border-charcoal/10 flex items-center justify-center text-charcoal hover:bg-white transition-all active:scale-90"
                    aria-label="Anterior"
                  >
                    <ChevronLeft size={20} />
                  </button>
